...
import { arrayGetItemByRoute, routeObject } from '../utils/object'
import { pathFromStrings } from '../utils/string'
        ...
        >
          ...
          >
            ...
            {menuItem.map((menu) =>
              menu?.submenu ? (
                <SubMenu
                  key={pathFromStrings(navRoute, menu.route)}
                  icon={menu.icon}
                  title={menu.name}
                >
                  {menu.submenu.map((submenu) => (
                    <Menu.Item
                      key={pathFromStrings(navRoute, menu.route, submenu.route)}
                    >
                      {submenu.name}
                    </Menu.Item>
                  ))}
